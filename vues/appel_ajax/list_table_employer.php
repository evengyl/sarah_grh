<table id="table_list_employer" style="background:white; color:black;" class="table table-hover table-responsive table-striped table-bordered">
	<tr>
		<th style="width:4%;">Nom</th>
		<th style="width:7%;">GSM</th>
		<th style="width:6%;">Habite</th>
		<th style="width:13%;">Lundi</th>
		<th style="width:13%;">Mardi</th>
		<th style="width:13%;">Mercredi</th>
		<th style="width:13%;">Jeudi</th>
		<th style="width:13%;">Vendredi</th>
		<th style="width:13%;">Samedi</th>
	</tr><?
	if(!empty($list_employer))
	{
		...
		{?>
			<tr>
				<td contenteditable="true" data-action="" data-column="nom" data-id="<?= $employer->id ?>"><?= $employer->nom ?></td>
				<td contenteditable="true" data-action="" data-column="gsm" data-id="<?= $employer->id ?>"><?= $employer->gsm ?></td>
				<td contenteditable="true" data-action="" data-column="habite" data-id="<?= $employer->id ?>"><?= $employer->habite ?></td>
				
				<td contenteditable="true" data-action="" 
...
<table id="table_list_employer" style="background:white; color:black;" class="table table-hover table-responsive table-striped table-bordered">
	<tr>
		...
		<th style="width:8%;">Habite</th>
		<th style="width:16%;">Shop le plus proche n°1</th>
		<th style="width:16%;">Shop le plus proche n°2</th>
		<th style="width:16%;">Shop le plus proche n°3</th>
		<th style="width:16%;">Shop le plus proche n°4</th>
